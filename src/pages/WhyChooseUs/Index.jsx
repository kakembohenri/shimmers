const Index = () => {
    ...
    const style5 = `#slcr_icon_text_last65197de83cb2a.main__icon { display: block; text-align: center; color: #ffffff !important; border-radius: 50%; border-color: #fba311 !important; background: #fba311 !important;  height: 50px; width: 50px; line-height: 50px; font-size: 25px; transition: all ease .3s; -webkit-transition: all ease .3s; } [data-hover-target="box"]:hover #slcr_icon_text_last65197de83cb2a.main__icon, [data-hover-target="icon"] #slcr_icon_text_last65197de83cb2a.main__icon:hover { background: #fba311 !important; border-color: #fba311 !important; color: #ffffff !important; } #slcr_icon_text_content65197de83cb2a{  } #slcr_icon_text_img65197de83cb2a{  height: auto; width: 60px;   border-radius: 0px;  }`
