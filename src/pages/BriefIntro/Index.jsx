const BriefIntro = () => {
  ...
  return (
    <div data-vc-full-width="true" data-vc-full-width-init="true" className="main-component intro-custom slcr_row_curve vc_row wpb_row vc_row-fluid content-light data-bg-color-650ee07e18324 vc_custom_1639235925789 vc_row-has-fill row-z-index-650ee07e18324 intro" data-bg-overlay="10" data-bg-color-650ee07e18324="10" style={{marginLeft: "0 !important"}}>
            <div className="wpb_column vc_column_container content-dark vc_col-sm-8 vc_col-lg-6 vc_col-md-9 vc_col-xs-12 column-z-index-650ee07e1874a">
                <div className="vc_column-inner vc_custom_1555946261937">
                    <div className="wpb_wrapper">
                        <style>
                            {style1}
                        </style>
                        <h6 id="slcr_custom_heading_650ee07e18cca" className="vc_custom_heading sub-heading single font-700">Introducing Shimma Hub Co.Ltd</h6>
                        <div className="wpb_text_column wpb_content_element  vc_custom_1556213108911">
                            <div className="wpb_wrapper">
                        ...
                        <div className="vc_btn3-container vc_btn3-left"> 
                            <a href="#" id="btn_slcr_650ee07e19da7" className="btn   vc_custom_1555927878202  btn--lg font-700 btn--rounded    btn-shadow  btn--secondary  btn--icon-simple ">      <span>REQUEST A DEMO</span><i className="vc_btn3-icon fa fa-arrow-right slcr_icon_html_last_css_650ee07e19d9d"></i> 
                            </a>
                        </div>
                    </div>
                </div>
        ...
        {/* <svg version="1.1" className="shape__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1366 231" preserveAspectRatio="none" style="enable-background:new 0 0 1366 231;" xml:space="preserve">
            <path fill="#ffffff" d="M0,54c0,0,106,134,307,101c246-63,285-39,368-22c106,33,225,90,292,62c109-39,255-191,399-178 c0,128,0,214,0,214H0V54z"></path> 
            ...
            <path fill="#ffffff" style="opacity: 0.45" d="M1366,227c0,0,0-71.03,0-203c-198-44-439,252-559,156c-13,1,0.7-9.44-53-20c-116.23-22.86-254.55-23.5-371-17 C157,121-4,172.01-4,172.01"></path>
            </svg> */}
        </div>
        </div>
  )
